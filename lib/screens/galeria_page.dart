...
class _GaleriaPageState extends State<GaleriaPage>{
  final List<Map<String, String>> _lugares= [

    {
      ...
      'descrição':'Uma estrada inca cordilheira dos anedes com curvas e morros',
    },
    {
      'nome':'aurora boreal',
    ...
    },
    {
      ...
      'descrição':'Localizada no topo de uma montanha no distrito de Machupicchu, na província de Urubamba, no Peru',
    },
    {
      'nome':'Patagônia',
      'local':'Chile',
      'imagem': 'assets/images/Patagonia.jpg',
      'descrição':'A Patagônia Chilena é uma vasta região no extremo sul do continente americano, famosa por seus glaciares, montanhas imponentes, fiordes e parques nacionais',
    },
